...
export default function GithubCodeCard(props: Repository) {
  return (
    <div className="flex flex-col gap-y-3 rounded-md border-2 border-primary-700 bg-gray-900 p-3 shadow-lg">
      ...
      <div className="-mx-3 -mb-3 grid grid-cols-3 items-center divide-x-2 divide-gray-900 rounded-b-md border-t border-primary-700">
